...
Im not sure that what I have written out is entirely error free but Ill need to edit it tommorow. The reason I needed this proof is that it is the key step to my proof of 2delta intervweiving, because now I can identify cycles in the homology before and after the move. Having done the proof, I am now wondering - can i prove this for a general tame isomporphism? I think so, I will need to review the definition of a general tame isomorphism, but this could get us something that works for move 2 as well. Then the only thing left is to show that when the new generators from move two are added to a bar, their heights can be made less or equal to the other heights that generate the bar, so that the length of the bar is not effected. We will look at this tommorow. I believe that this is related to, or exactly what, what I was trying to prove before I was interupted by Ethans relevation that islands exist. However, I can simply consider whether this is true (the exact result was about the tier of the resulting generator) in knots that flood, which would be a lot of knots.
